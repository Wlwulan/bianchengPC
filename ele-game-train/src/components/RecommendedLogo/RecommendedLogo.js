...
@connect(({ globalData }) => ({
  ...
  setPlayVideoIndex(playVideoIndex) { dispatch(setPlayVideoIndex(playVideoIndex)) },
...
class RecommendedLogos extends Component {
  ...
  render() {
    ...
    return (
      <View className="RecommendedLogo">
        ...
        <View>
          {
            playVideoIndex !== curNumber ?
              <View className="video-mask">
                <Image
                  style="width: 750rpx;height: 563rpx;"
                  src={poster}
                ></Image>
                <View className="mask">
                  <View
                    ...
                    onClick={this.playCurrVideo.bind(this)}
                  ></View>
                </View>
              </View>
              :

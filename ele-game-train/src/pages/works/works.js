...
class works extends Component {
    ...
    render() {
        ...
        return (
            <View className={`index ${currentTab !== 0  &&  (favorNum > 0 ? 'index-space1' : 'index-space2' )}`} >
                <View className={` header ${currentTab !== 0 ? 'fixed' : '' }`}>
                    {
                        favorNum > 0 &&
                        <View className={`favour-notice `}>
                            <View
                                className='favour-notice-remind'
                                onClick={this.toMyFavor}
                            >

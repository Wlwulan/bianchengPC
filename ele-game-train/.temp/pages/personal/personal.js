...
class personal extends Component {
  ...
  render() {
    ...
    return <View className="personal">
                <View className="header">
                    ...
                    <View className="header-right">
                        <View className="msg-top">
                            ...
                            <Text onClick={this.toggleModel.bind(this, 'isbuyBtn')} className="isbuy">
                        ...
                        <View className="msg-bottom">
                            <View className="progress-warp">
                                <View className="progress">
                                    <Text className="progress-bar" style={`width: ${userInfo['upgradeProgress'] && userInfo['upgradeProgress'] * 360}rpx`}></Text>
                                </View>
          ...
          return !(userInfo['isPurchase'] == 0 && i == 1) && <View key={i} className="li" onClick={this.toDetailPage.bind(this, i)}>
                ...
                <ModalContainer isShow={isShowModel}>
                    <ModalContainerService onCloseModal={this.toggleModel.bind(this)} top={-160}>
                        ...
                        {userInfo['isPurchase'] === 1 ? <View className="footerBtn">
                                    <Button className="close" onClick={this.toggleModel.bind(this)}>我知道了</Button>
                                </View> : <View className="footerBtn">
                ...
                <Authorize isShow={showAuthorized} onAuthorize={this.authorizeCallBack.bind(this)}>
                </Authorize>
            </View>;
  }

...
import { View, Image, Text, Video, PullDownRefresh } from '@tarojs/components';
...
let paySuccess = class paySuccess extends Component {
  constructor() {
    super(...arguments);
          ...
          <View style="padding: 40rpx 10rpx;">
            ...
            <View>
              <LeftRigtDisplay renderLeft={<LeftPart>
                  ...
                  </LeftPart>} renderRight={<RightPart>
...
paySuccess = tslib_1.__decorate([connect(({ globalData, authData }) => ({
  globalData,
  authData
}))], paySuccess);

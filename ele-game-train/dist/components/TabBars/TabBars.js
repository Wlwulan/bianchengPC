...
var tabBar = (_dec = (0, _index4.connect)(function (_ref) {
  ...
  return {
    setCurrentTab: function setCurrentTab(data) {
      dispatch((0, _globalData.setCurrentTab)(data));
    }
  };
  ...
  function tabBar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = tabBar.__proto__ || Object.getPrototypeOf(tabBar)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["currentId", "setCurrentTab", "list"], _this.state = {
      currentId: 0
  ...
  _createClass(tabBar, [{
    ...
    key: "handleIndex",
    value: function handleIndex(index) {
      this.setState({
        currentId: index
      });
      this.props.setCurrentTab(index);
      _index3.default.setNavigationBarTitle({
    ...
    value: function _createData() {
      ...
      var currentId = this.__state.currentId;

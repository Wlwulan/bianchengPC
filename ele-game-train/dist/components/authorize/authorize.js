...
var authorize = (_dec = (0, _index4.connect)(function (_ref) {
  ...
  function authorize() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = authorize.__proto__ || Object.getPrototypeOf(authorize)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["isShow", "isRegister", "authData", "setAuthData", "__fn_onAuthorize"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
            ...
            switch (_context.prev = _context.next) {
              ...
              case 13:
                ...
                this.setState({ isRegister: true }, function () {
                  _this2.__triggerPropsFn("onAuthorize", [null].concat([]));
                });
...
authorize.$$events = ["onGetUserInfo"];
exports.default = authorize;

Component(require('../../npm/@tarojs/taro-weapp/index.js').default.createComponent(authorize));